...
export class MarvelrivalsComponent implements OnInit {
  constructor(private router: Router) {}
  unit = 'Coins';
  guideImage = 'https://www.lnwtrue.com/_next/image?url=https%3A%2F%2Fmedia.lnwtrue.com%2Fimages%2Fuid%2Fmarvel-rivals%2FF6hA1NY4uKNdUe.webp&w=1200&q=75';
...
products = [
  { id: 'mr-0100', value: 100, amount: 29 },
  { id: 'mr-0500', value: 500, amount: 145 },
  { id: 'mr-1000', value: 1000, amount: 279 },
  { id: 'mr-2180', value: 2180, amount: 559 },
  { id: 'mr-5680', value: 5680, amount: 1369 },
  { id: 'mr-11680', value: 11680, amount: 2719 }
];
  ...
  ngOnInit(): void {
    const saved = localStorage.getItem('saved.uid.marvelrivals');
    if (saved) { this.uid = saved; this.validateUid(); }
  }
  saveUid(): void {
    if (!this.uid) return;
    localStorage.setItem('saved.uid.marvelrivals', this.uid);
  ...
  confirmPay(): void {
    ...
    setTimeout(() => {
      this.isPaying = false;
      this.isPaid = true;
      this.orderId = 'MR' + Math.floor(100000 + Math.random()*900000);
